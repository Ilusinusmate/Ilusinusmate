...
%% ---------- Resumo ----------
\section*{Resumo}
Desenvolvedor backend com 2 anos de experiência profissional em \textbf{Python}, atuando com
...
\cargo{Logon Informática}{Mobile \& Backend Developer}{mai/2025 -- atual}{Software house de
...
$\cdot$ Espanhol (básico) $\cdot$ Libras (intermediário)
