...
\hypersetup{
  ...
  estado, injecao de dependencia, testes unitarios, widget tests, testes de integracao, API REST,
  FastAPI, Python, Git, Gitflow, CI/CD, GitHub Actions, Clean Code, SOLID, Scrum}
}
...
\raggedleft\includegraphics[width=2.7cm]{foto.jpg}
\end{minipage}
...
\textbf{Qualidade mobile:} testes unitários, testes de \textit{widget} e de integração, code review,
