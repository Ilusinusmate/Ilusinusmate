...
Fonte oficial: **Currículo Lattes** (http://lattes.cnpq.br/0275324617447099), última atualização
declarada em 20/10/2025. O Lattes é a referência para títulos, anos e papéis; o restante do dossiê
...
> João Gabriel Salvador Paiva é natural de Campina Grande – PB. Formou-se na rede pública federal de
> ensino pelo IFPB, onde concluiu o curso técnico integrado e desenvolveu suas habilidades na área de
> computação por meio da participação em olimpíadas científicas, projetos de pesquisa e extensão,
> lecionamento de minicursos e publicação de artigos acadêmicos. Atua profissionalmente como
> Desenvolvedor de Software, com experiência em diversas áreas, tendo ênfase em Backend e
> Desenvolvimento Mobile. Atualmente é graduando em Ciência da Computação pela UFCG e membro do grupo
> de pesquisa LAPLIN (IFPB/CNPq), onde investiga a influência das tecnologias da informação e da
> comunicação na formação de sujeitos e subjetividades.

## Vínculo de pesquisa

**LAPLIN — Laboratório de Análise e Processamento de Linguagem Natural (IFPB/CNPq)** — membro do
...
Python dividido em **grupo experimental (com IA)** e **grupo de controle (sem IA)**, com coleta e
...
más práticas linguísticas para geração automática de texto. Metodologia: revisão sistemática da
...
## Materiais suplementares de pesquisa (repositórios públicos)

Repositórios de apoio a artigos hospedados na conta `Ilusinusmate`. **Não constam no Lattes** —
confirmar em cada caso se a autoria é própria, em coautoria ou apenas hospedagem antes de citar.

| Repositório | Tema |
| --- | --- |
| `enemLLMWEI2026` | "Avaliação Automatizada de Redações com Grandes Modelos de Linguagem: Um Estudo Experimental no Contexto do ENEM" |
| `smjss26` | "Large Language Models in Scrum Management: Findings from a Global Survey of Practitioners" — submetido ao *Journal of Software and Systems* |
| `surveyxp26` | Survey sobre adoção de LLMs na gestão Scrum — 70 respostas consentidas, dados anonimizados e scripts |
| `llm-us-quality-xp26` | "Evaluating the Quality of User Stories" — GPT-5, GPT-5-mini e GPT-4 sob o framework QUS |
| `softcomLLMPMP2026` | "Evaluating LLM Accuracy on PMP Certification Questions" — submetido ao SOFTCOM 2026 |
| `paper_scrum` | Acurácia do ChatGPT-5 Nano em questões de certificação Professional Scrum Master |

**Temas transversais:** LLMs em educação e engenharia de software, benchmark/avaliação de modelos,
metodologia experimental, análise estatística em Python.
